...
<head>
    ...
    <title>20 questions quiz - Page 19</title>
    ...
    <div class="que-ans-id">        
        ...
        <form action="page19.php" method="POST" enctype="multipart/form-data">
            <section class="section-1">
                ...
                <label for="question" class="question"><?php echo $_SESSION['questions'][18] ?></label><br>
        
            </section>
            <section class="section-2">

                <br><label for="answer" class="answer" style="font-size: 3vw;"><?php echo $_SESSION['answers'][18][0] ?></label><br>
                <input type="radio" name="radio" value="radio-1" class="radio-class">

                <br><label for="answer" class="answer" style="font-size: 3vw;"><?php echo $_SESSION['answers'][18][1] ?></label><br>
                <input type="radio" name="radio" value="radio-2" class="radio-class">

                <br><label for="answer" class="answer" style="font-size: 3vw;"><?php echo $_SESSION['answers'][18][2] ?></label><br>
                <input type="radio" name="radio" value="radio-3" class="radio-class">

                <br><label for="answer" class="answer" style="font-size: 3vw;"><?php echo $_SESSION['answers'][18][3] ?></label><br>
